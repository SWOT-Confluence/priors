...
class GagePullR:
    ...
    def pull(self):
        ...
        pfpm=Path("C:/Users/coss.31/OneDrive - The Ohio State University/Documents/SWOT_Mission_REPOS/SOS_OSC_WORKING_COPY/SASA.pkl")
        #status = pickle.save(pfpm,df_list)
...
#status = pickle.save(pfpm,df_list)
        ...
        # Store data (serialize)
         DicSave=Path("C:/Users/coss.31/OneDrive - The Ohio State University/Documents/SWOT_Mission_REPOS/SOS_OSC_WORKING_COPY/SAdic.pkl")
        #status = pickle.save(DicSave,self.riggs_dict)
    
        self.riggs_dict = pickle.load(DicSave)
